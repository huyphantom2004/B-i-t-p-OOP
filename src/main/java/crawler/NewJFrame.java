...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void getDataFromUrl(String url) {
        try {
            ...
            newJsonInfo.put("Tóm tắt bài viết (nếu có)", summary);
            newJsonInfo.put("Tiêu đề bài viết", title);
            newJsonInfo.put("Nội dung chi tiết bài viết", content);
        ...
        try (FileWriter fileWriter = new FileWriter("src/main/java/FileStorge/Contents.json")) {
            ...
            "<b>Tóm tắt bài viết (nếu có):</b> " + summary + "<br>" +
            "<b>Tiêu đề bài viết:</b> " + title + "<br>" +
            "<b>Nội dung chi tiết bài viết:</b> " + content + "<br>" +
            "<b>Ngày tạo:</b> " + extractDate(lastUpdatedDate) + "<br>" +
            "<b>Hashtag đi kèm:</b> " + Arrays.toString(hashtags) + "<br>" +
            "<b>Tên tác giả nếu có:</b> " + extractauthor(author) + "<br>" +
